...
class AccountingJobsReportServiceTest {
    ...
    private Job buildSampleJob() {
        ...
        PipelineStatusDefinition completed = mock(PipelineStatusDefinition.class);
        when(completed.getLabel()).thenReturn("Completed");
        when(job.getStatusDefinition()).thenReturn(completed);
