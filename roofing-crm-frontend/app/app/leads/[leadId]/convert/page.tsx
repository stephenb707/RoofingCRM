...
export default function ConvertLeadPage() {
  ...
  const [nextStepJobId, setNextStepJobId] = useState<string | null>(null);
          ...
          actions={[
            {
              ...
              onClick: () => router.push(`/app/schedule?jobId=${nextStepJobId}`),
              testId: "convert-next-step-schedule",
            },
            {
              label: "Create estimate",
              onClick: () => router.push(`/app/jobs/${nextStepJobId}/estimates/new`),
              variant: "secondary",
              testId: "convert-next-step-estimate",
            },
          ]}
          onClose={() => router.push(`/app/jobs/${nextStepJobId}`)}
          dismissLabel="Go to job"
        />
      )}
    </>
  );
